...
const MENUS: Record<string, {
    ...
    Geschäftskunden: {
        ...
        links: [
            { label: 'Gastronomie & Lebensmittel', href: '/geschaeftskunden/gastronomie' },
            { label: 'Hotellerie & Gewerbe',       href: '/geschaeftskunden/hotellerie' },
            { label: 'Lager & Logistik',           href: '/geschaeftskunden/lager' },
            { label: 'Öffentlicher Sektor',        href: '/geschaeftskunden/oeffentlich' },
        ],
        cta: 'Mehr erfahren',
            ...
            <header className={`fixed top-0 left-0 right-0 z-[9999] transition-all duration-300 border-b ${
                isPortal 
                    ...
                    : (isSolid 
                        ...
                        : 'bg-white/45 dark:bg-[#161616]/80 backdrop-blur-[8px] shadow-[0_4px_30px_rgba(0,0,0,0.05)] border-[#C8102E] dark:border-[#C8102E] border-b-2')
            }`}>
                ...
                <div className={`max-w-[1280px] mx-auto px-5 h-[68px] flex items-center justify-between gap-4 ${isPortal ? 'pr-[80px] xl:pr-5' : ''}`}>
                    ...
                    <Link href="/" className="flex items-center gap-3 no-underline shrink-0">
                        ...
                        <div className="flex flex-col leading-none">
                            <span className={`font-black text-[19px] tracking-[-0.03em] uppercase ${isPortal ? 'text-slate-900 dark:text-white' : 'text-[#1E293B] dark-header-text'}`}>Kammerjäger</span>
                                ...
                                <Link
                                    ...
                                    className={`flex items-center h-full px-[18px] text-[15px] font-medium whitespace-nowrap transition-colors border-b-[3px] duration-150 ${
                                        hoveredMenu === key 
                                            ...
                                            : (isPortal ? 'text-slate-600 dark:text-white hover:text-slate-900 dark:hover:text-slate-300 border-transparent' : 'text-slate-600 dark-header-text hover:text-slate-900 border-transparent')
                                    }`}
                                >
                                    {key}
                                </Link>
                    ...
                    <div className="hidden lg:flex items-center gap-3 shrink-0">
                        <a href="tel:015112345678" className="flex items-center gap-1.5 text-[15px] font-medium text-[#C8102E] no-underline">
                            <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                            Kontakt
                        </a>
                        <a href="tel:015112345678" className="px-[18px] py-[7px] text-[15px] font-bold text-[#C8102E] whitespace-nowrap">
                            0151 12345678
                        </a>
                    ...
                    <div className="flex lg:hidden items-center gap-2">
                        ...
                        <a href="tel:015112345678" className="flex items-center justify-center w-10 h-10 text-[#C8102E]" aria-label="Anrufen">
